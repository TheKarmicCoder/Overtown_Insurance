            ...
            <Paper
              sx={{
                ...
                '@media (max-width: 768px)': {
                  ...
                  marginTop: '8rem', // Adjust marginTop for smaller screens
                  marginBottom: '8rem', // Adjust marginBottom for smaller screens
                },
                '@media (min-width: 769px) and (max-width: 1024px)': {
                  height: 'auto', // Adjust height for smaller screens
                  marginTop: '24.5rem', // Adjust marginTop for smaller screens
                  marginBottom: '8rem', // Adjust marginBottom for smaller screens
                  marginLeft: '1rem', // Adjust marginRight for smaller screens
                },
              }}
            >
          ...
          <Grid item xs={12} md={6}>
            <Box
              sx={{
                ...
                '@media (max-width: 1200px)': {
                  marginRight: '15rem', // Adjust marginRight for medium-sized screens
                  marginTop: '-10px'
                },
                '@media (max-width: 992px)': {
                  marginRight: '8rem', // Adjust marginRight for smaller screens
                },
                '@media (max-width: 768px)': {
                  display: 'none',
            ...
            >
              ...
              <img
                src="/maggie.jpg"
                alt="About Us"
                style={{ width: '100%', borderRadius: '8px', marginBottom: '20px', marginLeft: '30rem' }}
              />
              <Box
                sx={{
                  display: 'flex',
